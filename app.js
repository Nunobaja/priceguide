(() => {
  ...
  async function copyCurrentPageLink() {
    ...
    if (navigator.clipboard && typeof navigator.clipboard.writeText === "function") {
      try {
        ...
        copied = copyLinkWithSelection(url);
      }
    } else {
      copied = copyLinkWithSelection(url);
    }
  ...
  function copyLinkWithSelection(url) {
  ...
  function getServiceHelperText(service) {
    const spanishText = typeof service.helperText === "string" ? service.helperText.trim() : "";
    const englishText = typeof service.helperTextEn === "string" ? service.helperTextEn.trim() : "";
  ...
  function renderQuestions(service) {
    const helperText = getServiceHelperText(service);
