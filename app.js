(() => {
  ...
  const toneCopy = {
    friendly: {
      ...
      priceDisclaimer: "El rango es aproximado. El precio final se confirma según los detalles del servicio.",
      initialEstimateNote: "Rango aproximado. El precio final se confirma según los detalles del servicio.",
    ...
    technical: {
      ...
      priceDisclaimer: "El rango es aproximado. El precio final se confirma después de revisar los detalles del servicio.",
      initialEstimateNote: "Rango aproximado. El precio final se confirma después de revisar los detalles del servicio.",
  ...
  const uiCopy = {
    ...
    en: {
      ...
      initialEstimateNote: "Approximate range. The final price is confirmed based on the service details.",
  ...
  // This object centralizes handoff details for summary, copy-link, and contact actions.
