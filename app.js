(() => {
  ...
  const uiCopy = {
    es: {
      ...
      unconfirmedNoWhatsapp: "WhatsApp no confirmado. Usa el teléfono público para contactar al negocio.",
    ...
    en: {
      ...
      unconfirmedNoWhatsapp: "WhatsApp not confirmed. Use the public phone to contact the business.",
      copyLink: "Copy link",
  ...
  function updateWhatsAppContactDetails() {
    ...
    const pending = isWhatsAppPending();
    ...
    if (helperText) {
      helperText.textContent = !whatsapp
        ? labels.unconfirmedNoWhatsapp
        : getCopy("whatsappHelperText");
    }
  }
